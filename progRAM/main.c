...
int main(void) {
	...
	printf("Test 1: Attempting to transmit 32b on a single core, est. %ims to complete.\n",32000);
	...
	printf("Test 2: Attempting to transmit 32b over 4 cores, est. 32000ms to complete.\n");
	start = time(NULL) * 1000;
